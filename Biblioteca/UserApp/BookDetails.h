...
public:
	BookDetails() = default;
	BookDetails( std::string tags,float averageRating,int ratings1,int ratings2, int ratings3, int ratings4, int ratings5,std::string languageCode, std::string imageUrl);
